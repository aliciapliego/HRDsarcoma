...
```{r,echo=FALSE, warning=FALSE, message=FALSE}
## Read in the metadata and the col data 
coldata <- read.csv('/Users/aliciapliego/Projects/HRDsarcoma/data/rnaseq/MFS.meta.out.txt', sep = '\t')
countdata <- read.csv('/Users/aliciapliego/Projects/HRDsarcoma/data/rnaseq/MFS.counts.out.txt', sep = '\t', check.names = FALSE)
